...
if(isset($_POST['submit'])){
    ...
    (category_id,product_name,product_img_1,product_img_2,product_price,product_desc) VALUES
    ('$category','$product_name','$product_img_1','$product_img_2','$product_price','$product_desc')";
